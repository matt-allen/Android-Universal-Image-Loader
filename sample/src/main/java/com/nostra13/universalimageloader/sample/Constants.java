...
public final class Constants {
	...
	public static final String[] IMAGES = new String[] {
			...
			new SimpleTextImage("Adam", SimpleTextImage.COLOUR_DEEP_ORANGE, SimpleTextImage.COLOUR_WHITE, true, SimpleTextImage.TYPEFACE_CONDENSED).createUrl(),
			new SimpleTextImage("Ben", SimpleTextImage.COLOUR_INDIGO, SimpleTextImage.COLOUR_WHITE, true, SimpleTextImage.TYPEFACE_MONOSPACE).createUrl(),
			new SimpleTextImage("Gary Smith").createUrl(),
			new SimpleTextImage("Tom Jones", SimpleTextImage.COLOUR_RED, SimpleTextImage.COLOUR_WHITE, true, SimpleTextImage.TYPEFACE_NORMAL).createUrl(),
			new SimpleTextImage("Test Person", SimpleTextImage.COLOUR_WHITE, SimpleTextImage.COLOUR_RED, true, SimpleTextImage.TYPEFACE_NORMAL).createUrl(),
			new GravatarImage("ianduncansmith@3sidedcube.com").createUrl() + "±" + new SimpleTextImage("Ian Duncan Smith").createUrl(),
